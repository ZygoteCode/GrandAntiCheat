...
public class Vec3D {
	   ...
	   private static final float[] bb = new float[65536];
	   ...
	   public Vec3D a() {
	      double d0 = (double)sqrt(this.a * this.a + this.b * this.b + this.c * this.c);
	   ...
	   public double b() {
	      return (double)sqrt(this.a * this.a + this.b * this.b + this.c * this.c);
	   }
	   ...
	   public static float sin(float f) {
	      return bb[(int)(f * 10430.378F) & '\uffff'];
	   }

	   public static float cos(float f) {
	      return bb[(int)(f * 10430.378F + 16384.0F) & '\uffff'];
	   }
	}

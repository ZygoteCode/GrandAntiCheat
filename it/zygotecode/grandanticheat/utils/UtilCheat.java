...
{
    public static LivingEntity getRaycastTarget(Player player, int range)
    {
    ...
    public static float[] getRotations(Player player, LivingEntity entity)
    {
    	double pX = player.getLocation().getX();
        double pY = player.getLocation().getY() + (double) player.getEyeHeight();
        double pZ = player.getLocation().getZ();
        double eX = entity.getLocation().getX();
        double eY = entity.getLocation().getY() + (double) (entity.getEyeHeight() / 2.0f);
